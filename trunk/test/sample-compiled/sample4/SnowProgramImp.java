...
if ((snw_evaluateFitness(organism)).equals(symbols.get("~endFitness"))){

for(i = new SnowAtom(0); i.nequals(new SnowAtom(7));i.plus(new SnowAtom(1))){snw_print(new SnowAtom("queen at").plus(i).plus(new SnowAtom(",")).plus((snw_nth(i,symbols.get("organism").getField("chromsome").getField("gene")))).plus(new SnowAtom("\n")));
